Rails.application.routes.draw do
  namespace :api do
    namespace :v1, defaults: { format: :json } do
      ...
      post '/projects/:project_code/tickets/:ticket_ticket_no/add_related_ticket',
           to: 'ticket_relations#add_related_ticket', as: 'add_related_ticket'
      delete '/projects/:project_code/tickets/:ticket_ticket_no/delete_related_ticket',
             to: 'ticket_relations#delete_related_ticket', as: 'delete_related_ticket'
    end
  end
end
